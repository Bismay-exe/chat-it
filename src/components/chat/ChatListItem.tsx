        ...
        <div className="flex-1 flex flex-col gap-2 leading-none pr-0 md:pr-4 overflow-hidden pointer-events-none">
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              {is_pinned && <Pin className="w-3.5 h-3.5 text-muted-foreground/60 fill-foreground rotate-45" />}
              {is_muted && <BellOff className="w-3.5 h-3.5 text-muted-foreground/60 fill-foreground" />}
